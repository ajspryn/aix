            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm">
                    ...
                    <tr class="border-b border-zinc-800/50 hover:bg-zinc-800/30 transition-colors">
                        <td class="py-4 px-4 text-zinc-400 font-mono"><?php echo e($log->created_at->format('Y-m-d H:i:s')); ?></td>
                        <td class="py-4 px-4 text-white font-medium"><?php echo e($log->monitoredArea ? $log->monitoredArea->name : 'Node Tidak Dikenal'); ?></td>
                        <td class="py-4 px-4">
                            <span class="<?php echo e($log->temperature > 35 ? 'text-rose-400 font-bold' : 'text-zinc-300'); ?>">
                                <?php echo e($log->temperature); ?>&deg;C
                            </span>
                        </td>
                        <td class="py-4 px-4">
                            <span class="<?php echo e($log->rainfall_mm > 100 ? 'text-blue-400 font-bold' : 'text-zinc-300'); ?>">
                                <?php echo e($log->rainfall_mm); ?> mm
                            </span>
                        </td>
                        <td class="py-4 px-4">
                            <span class="<?php echo e($log->soil_moisture < 20 ? 'text-amber-400 font-bold' : 'text-zinc-300'); ?>">
                                <?php echo e(number_format($log->soil_moisture, 2)); ?>%
                            </span>
                        </td>
                        <td class="py-4 px-4">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/aix/resources/views/admin/telemetry.blade.php ENDPATH**/ ?>