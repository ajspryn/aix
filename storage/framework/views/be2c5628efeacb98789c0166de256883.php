...
<div class="px-8 py-8 w-full max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div class="glass-panel p-6 rounded-xl">
             ...
             <div class="text-3xl font-light text-white"><?php echo e($totalMitigated); ?> <span class="text-sm text-zinc-500">Node</span></div>
        </div>
        <div class="glass-panel p-6 rounded-xl">
             <div class="text-zinc-400 text-xs font-semibold uppercase tracking-wider mb-2">Total Mitigasi Gagal (Failed)</div>
             <div class="text-3xl font-light text-rose-500"><?php echo e($totalFailed); ?> <span class="text-sm text-zinc-500">Node</span></div>
        </div>
        <div class="glass-panel p-6 rounded-xl relative overflow-hidden">
             ...
             <div class="text-3xl font-light text-emerald-400">Rp <?php echo e(number_format($estimatedLossSaved, 0, ',', '.')); ?></div>
        </div>
        <div class="glass-panel p-6 rounded-xl">
             <div class="text-zinc-400 text-xs font-semibold uppercase tracking-wider mb-2">Total Dana Donasi Dicairkan</div>
             <div class="text-3xl font-light text-white">Rp <?php echo e(number_format($realPooledFunds, 0, ',', '.')); ?></div>
             <div class="text-xs text-emerald-500 mt-2">
                 ROI: <?php echo e($realPooledFunds > 0 ? number_format(($estimatedLossSaved / $realPooledFunds), 2, ',', '.') : 0); ?>x Margin
             </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         <div class="glass-panel p-6 rounded-xl flex flex-col">
              ...
              <div class="flex-1 overflow-y-auto pr-2 space-y-3">
                   <?php $__empty_1 = true; $__currentLoopData = $criticalAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                   <div class="bg-zinc-900/50 border border-zinc-800 rounded-lg p-3">
                        <div class="flex justify-between items-center mb-1">
                             <div class="font-medium text-zinc-300 text-sm"><?php echo e($area->name); ?></div>
                             <div class="text-xs font-mono <?php echo e($area->current_risk_score > 0.8 ? 'text-rose-500' : 'text-orange-400'); ?>">
                                  <?php echo e(round($area->current_risk_score * 100)); ?>% RISK
                             </div>
                        </div>
                        <div class="w-full bg-zinc-800 rounded-full h-1.5">
                             <div class="bg-gradient-to-r from-orange-400 to-rose-600 h-1.5 rounded-full" style="width: <?php echo e($area->current_risk_score * 100); ?>%"></div>
                        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const temps = <?php echo $temps; ?>;
    const rains = <?php echo $rains; ?>;
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ajspryn/Project/aix/resources/views/admin/analytics.blade.php ENDPATH**/ ?>